...
PROJECT_NAME=wandu-springboot-webservice
...
CURRENT_PID=$(pgrep -fl wandu-springboot-webservice | grep jar | awk '{print $1}')
...
JAR_NAME=$(ls -tr $REPOSITORY/jar/ |grep 'springboot-webservice' | tail -n 1)
